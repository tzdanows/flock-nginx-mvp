...
const (
	...
	PingServiceName = "v1.PingService"
)
...
const (
	...
	PingServicePingProcedure = "/v1.PingService/Ping"
)

// PingServiceClient is a client for the v1.PingService service.
type PingServiceClient interface {
	// Sends a ping request and returns a message with the timestamp.
	Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error)
}

// NewPingServiceClient constructs a client for the v1.PingService service. By default, it uses the
...
// Ping calls v1.PingService.Ping.
...
// PingServiceHandler is an implementation of the v1.PingService service.
...
func NewPingServiceHandler(svc PingServiceHandler, opts ...connect_go.HandlerOption) (string, http.Handler) {
	...
	return "/v1.PingService/", http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		switch r.URL.Path {
...
func (UnimplementedPingServiceHandler) Ping(context.Context, *connect_go.Request[v1.PingRequest]) (*connect_go.Response[v1.PingResponse], error) {
	return nil, connect_go.NewError(connect_go.CodeUnimplemented, errors.New("v1.PingService.Ping is not implemented"))
}
